...
class TianGan:
    ...
    def create_tian_gan_list(cls) -> List[PillarElement]:
        return [
            PillarElement(name=TianGanType.JIA.value, positive=True, sequence=1, wu_xing=WuXingSet.get_wood()),
            PillarElement(name=TianGanType.YI.value, positive=False, sequence=2, wu_xing=WuXingSet.get_wood()),
            PillarElement(name=TianGanType.BING.value, positive=True, sequence=3, wu_xing=WuXingSet.get_fire()),
            PillarElement(name=TianGanType.DING.value, positive=False, sequence=4, wu_xing=WuXingSet.get_fire()),
            PillarElement(name=TianGanType.WU.value, positive=True, sequence=5, wu_xing=WuXingSet.get_earth()),
            PillarElement(name=TianGanType.JI.value, positive=False, sequence=6, wu_xing=WuXingSet.get_earth()),
            PillarElement(name=TianGanType.GENG.value, positive=True, sequence=7, wu_xing=WuXingSet.get_metal()),
            PillarElement(name=TianGanType.XIN.value, positive=False, sequence=8, wu_xing=WuXingSet.get_metal()),
            PillarElement(name=TianGanType.REN.value, positive=True, sequence=9, wu_xing=WuXingSet.get_water()),
            PillarElement(name=TianGanType.GUI.value, positive=False, sequence=10, wu_xing=WuXingSet.get_water())
        ]
...
class DiZhi:
    ...
    def create_di_zhi_list(cls) -> List[PillarEarthElement]:
        return [
            PillarEarthElement(
                ...
                start_time=time(23, 0, 0), end_time=time(1, 0, 0), wu_xing=WuXingSet.get_water()
            ),
            PillarEarthElement(
                name=DiZhiType.CHOU.value, positive=False, sequence=2,
                start_time=time(1, 0, 0), end_time=time(3, 0, 0), wu_xing=WuXingSet.get_earth()
            ),
            PillarEarthElement(
                name=DiZhiType.YIN.value, positive=True, sequence=3,
                start_time=time(3, 0, 0), end_time=time(5, 0, 0), wu_xing=WuXingSet.get_wood()
            ),
            PillarEarthElement(
                name=DiZhiType.MAO.value, positive=False, sequence=4,
                start_time=time(5, 0, 0), end_time=time(7, 0, 0), wu_xing=WuXingSet.get_wood()
            ),
            PillarEarthElement(
                name=DiZhiType.CHEN.value, positive=True, sequence=5,
                start_time=time(7, 0, 0), end_time=time(9, 0, 0), wu_xing=WuXingSet.get_earth()
            ),
            PillarEarthElement(
                name=DiZhiType.SI.value, positive=False, sequence=6,
                start_time=time(9, 0, 0), end_time=time(11, 0, 0), wu_xing=WuXingSet.get_fire()
            ),
            PillarEarthElement(
                name=DiZhiType.WU.value, positive=True, sequence=7,
                start_time=time(11, 0, 0), end_time=time(13, 0, 0), wu_xing=WuXingSet.get_fire()
            ),
            PillarEarthElement(
                name=DiZhiType.WEI.value, positive=False, sequence=8,
                start_time=time(13, 0, 0), end_time=time(15, 0, 0), wu_xing=WuXingSet.get_earth()
            ),
            PillarEarthElement(
                name=DiZhiType.SHEN.value, positive=True, sequence=9,
                start_time=time(15, 0, 0), end_time=time(17, 0, 0), wu_xing=WuXingSet.get_metal()
            ),
            PillarEarthElement(
                name=DiZhiType.YOU.value, positive=False, sequence=10,
                start_time=time(17, 0, 0), end_time=time(19, 0, 0), wu_xing=WuXingSet.get_metal()
            ),
            PillarEarthElement(
                name=DiZhiType.XU.value, positive=True, sequence=11,
                start_time=time(19, 0, 0), end_time=time(21, 0, 0), wu_xing=WuXingSet.get_earth()
            ),
            PillarEarthElement(
                name=DiZhiType.HAI.value, positive=False, sequence=12,
                start_time=time(21, 0, 0), end_time=time(23, 0, 0), wu_xing=WuXingSet.get_water()
            )
        ]
    ...
    def get_di_zhi_by_hour(cls, t: time) -> PillarEarthElement:
        di_zhi = [item for item in cls.get_di_zhi_list() if item.start_time <= t < item.end_time]
